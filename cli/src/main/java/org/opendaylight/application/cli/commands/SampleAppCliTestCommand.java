 ...
 */
package org.opendaylight.application.cli.commands;
...
public class SampleAppCliTestCommand extends AbstractAction {
    ...
    protected final SampleAppCliTestCommand service;

    public SampleAppCliTestCommand(final SampleAppCliTestCommand service) {
    ...
    protected Object doExecute() throws Exception {
         ...
         *
         * check it i changed it
         */
        final String testMessage = service.testCommand(testArgument);
        return testMessage;
    }

	private String testCommand(Object testArgument2) {
